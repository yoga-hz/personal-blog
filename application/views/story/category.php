<div class="jumbotron jumbotron-fluid text-dark" style="margin-top: 52.7px">
    <div class="container">
        <h1 class="display-4">Category</h1>
        <p class="lead">Showing post(s) with category <strong><?= ucfirst(substr(current_url(), 46)) ?></strong></p>
    </div>
</div>
    ...
    <div class="row">
        <div class="col-lg-9 col-md-9 col-sm-8">
            <article class="text-dark">
                ...
                <hr>
                <?php foreach ($post_category as $row) : ?>
                <div class="card">
                    <div class="card-body">
                        <div class="row">
